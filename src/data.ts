...
export type ProtocolFrame = {
  ...
  structure: { fieldId: string; width: number }[][];
...
export const FRAMES: ProtocolFrame[] = [
  {
    ...
    structure: [
      [
        { fieldId: "method", width: 33.33 },
        { fieldId: "uri", width: 33.34 },
        { fieldId: "version", width: 33.33 },
      ],
      [{ fieldId: "headers", width: 100 }],
      [{ fieldId: "body", width: 100 }],
    ],
  },
  {
    protocolId: "http",
    ...
    structure: [
      [
        { fieldId: "version", width: 33.33 },
        { fieldId: "statusCode", width: 33.34 },
        { fieldId: "statusText", width: 33.33 },
      ],
      [{ fieldId: "headers", width: 100 }],
      [{ fieldId: "body", width: 100 }],
    ],
  },
  {
    ...
    structure: [
      [
        { fieldId: "srcPort", width: 50 },
        { fieldId: "dstPort", width: 50 },
      ],
      [{ fieldId: "seqNum", width: 100 }],
      [{ fieldId: "ackNum", width: 100 }],
      [
        { fieldId: "dataOffset", width: 16.67 },
        { fieldId: "reserved", width: 8.33 },
        { fieldId: "flags", width: 25 },
        { fieldId: "window", width: 50 },
      ],
      [
        { fieldId: "checksum", width: 50 },
        { fieldId: "urgentPtr", width: 50 },
      ],
      [{ fieldId: "options", width: 100 }],
      [{ fieldId: "data", width: 100 }],
    ],
  },
  {
    protocolId: "udp",
  ...
  },
  {
    ...
    structure: [
      [
        { fieldId: "version", width: 12.5 },
        { fieldId: "ihl", width: 12.5 },
        { fieldId: "tos", width: 25 },
        { fieldId: "totalLength", width: 50 },
      ],
      [
        { fieldId: "identification", width: 50 },
        { fieldId: "flags", width: 8.33 },
        { fieldId: "fragmentOffset", width: 41.67 },
      ],
      [
        { fieldId: "ttl", width: 25 },
        { fieldId: "protocol", width: 25 },
        { fieldId: "headerChecksum", width: 50 },
      ],
      [{ fieldId: "srcAddr", width: 100 }],
      [{ fieldId: "dstAddr", width: 100 }],
      [{ fieldId: "options", width: 100 }],
      [{ fieldId: "data", width: 100 }],
    ],
  },
  {
    ...
    structure: [
      [
        { fieldId: "version", width: 12.5 },
        { fieldId: "trafficClass", width: 25 },
        { fieldId: "flowLabel", width: 62.5 },
      ],
      [
        { fieldId: "payloadLength", width: 50 },
        { fieldId: "nextHeader", width: 25 },
        { fieldId: "hopLimit", width: 25 },
      ],
      [{ fieldId: "srcAddr", width: 100 }],
      [{ fieldId: "dstAddr", width: 100 }],
      [{ fieldId: "data", width: 100 }],
  ...
  },
  {
    ...
    structure: [
      [
        { fieldId: "type", width: 25 },
        { fieldId: "code", width: 25 },
        { fieldId: "checksum", width: 50 },
      ],
      [{ fieldId: "restOfHeader", width: 100 }],
      [{ fieldId: "data", width: 100 }],
    ],
  },
  {
    ...
    structure: [
      [
        { fieldId: "preamble", width: 70 },
        { fieldId: "sfd", width: 30 },
      ],
      [{ fieldId: "dstMac", width: 100 }],
      [{ fieldId: "srcMac", width: 100 }],
      [{ fieldId: "etherType", width: 100 }],
      [{ fieldId: "payload", width: 100 }],
      [{ fieldId: "fcs", width: 100 }],
    ],
  },
] as const;
